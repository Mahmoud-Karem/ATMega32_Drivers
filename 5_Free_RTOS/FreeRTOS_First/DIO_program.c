...
DIO_ErrorStatus DIO_enumGetPinValue          (u8 Copy_u8PORT, u8 Copy_u8PIN, u8 * Copy_PtrData   )
{
	...
	if ((Copy_u8PORT <= DIO_PORTD) && (Copy_u8PIN <= DIO_PIN7))
	{
		...
		switch (Copy_u8PORT)
		{
		case DIO_PORTA: * Copy_PtrData = GET_BIT(PORTA_Register,Copy_u8PIN); break;
		case DIO_PORTB: * Copy_PtrData = GET_BIT(PORTB_Register,Copy_u8PIN); break;
		case DIO_PORTC: * Copy_PtrData = GET_BIT(PORTC_Register,Copy_u8PIN); break;
		case DIO_PORTD: * Copy_PtrData = GET_BIT(PORTD_Register,Copy_u8PIN); break;
		}
	}
 ...
 *Hint2 : This Function takes the Most 4 bits from the value (#) => ####xxxx AND put it in High Nibble
 *
 */
 ...
 *Hint2 : This Function takes the Least 4 bits from the value (#) => xxxx#### AND put it in Low Nibble
 *
 */
